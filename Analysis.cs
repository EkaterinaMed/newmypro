        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            switch (comboBox1.Text)
            {
               ...
               case "Количество вакансий по опыту работы":
                    ...
                    break;
                default:
                    MessageBox.Show("Вы не выбрали название запроса! Попробуйте еще раз.");
                    break;
            }
        }
